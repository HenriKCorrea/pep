...
\cite{diorio2025a} introduces an AI-enhanced Process Digital Twins (PDTs) framework, specifically tailored to support
    circular manufacturing practices, including reduce waste and extend product lifecycle.
...
The optimization layer hosts four independent AI agents to fulfill tasks such as 
    ...
    (b)~anomaly detection,
    (c)~behavioral classification and
