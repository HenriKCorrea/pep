...
The proposed Digital Ecosystem architecture draws inspiration from the Destination Earth (DestinE) initiative's virtual cloud layer~\cite{Nativi_Craglia_2021},
...
The scenario requires bridging multiple semantic gaps between the \texttt{opendigitaltwins-smartcities} ontology (KTWIN) and
    the CIM-based \texttt{opendigitaltwins-energygrid} ontology (Ditto):
...
Despite these limitations, the research provides valuable insights into the feasibility and potential benefits of agent-mediated DT interoperability,
    establishing a foundation for future work addressing production deployment challenges.
