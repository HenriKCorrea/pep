...
\begin{figure}[htbp]
    ...
    \caption{Multi-layer agent-mediated Digital Twin interoperability architecture. The Agent Supervisor in the Coordination Layer represents the core contribution of this work, enabling semantic negotiation between heterogeneous DT platforms through A2A protocol mediation.}
