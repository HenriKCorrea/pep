...
\begin{table}[H]
    ...
    \begin{tabular}{l|c|c|c|p{2.5cm}|p{2.2cm}|p{6.5cm}}
        ...
        \cite{morabito2025a} & Y & Y & N & Modular + GenAI & Smart campus & 
        ...
        \cite{juarez2025a} & Y & Y & N & NGSI-LD + agents & Synthetic mfg data & 
        Agents for intra-domain orchestration; no cross-domain semantic mapping protocols \\
        \hline
...
\vspace{0.5em}
\noindent\textbf{Legend:} DT = Digital Twin Interoperability; AI = AI Agents/Multi-Agent Systems; XD = Cross-Domain; Y = Yes; N = No; KG = Knowledge Graph; Mfg = Manufacturing